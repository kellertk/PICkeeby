...
function Find-IPE {
    ...
    # On Windows, prefer ipecmd.exe over the jar
    $searchPaths = @(
        ...
        "D:\Program Files\Microchip\MPLABX\v*\mplab_platform\mplab_ipe\ipecmd.exe",
        "$env:LOCALAPPDATA\Microchip\MPLABX\v*\mplab_platform\mplab_ipe\ipecmd.exe"
    )
